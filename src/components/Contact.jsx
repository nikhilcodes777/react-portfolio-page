...
const Contact = () => {
  ...
  return (
    <motion.section
      ...
      id="Home" className="flex flex-col gap-16 justify-center items-center h-screen sm:flex-row">
      <motion.img
      ...
      <motion.div
        ...
        <h1 className="text-2xl font-bold sm:text-5xl">Hi, It&apos;s <span className="text-primary">Nikhil</span></h1>
        <h3 className="mt-2 text-xl font-bold sm:text-4xl">I&apos;m a <span ref={el} className="text-primary"></span></h3>

        <p className="mt-7 font-bold text-pretty">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Veniam iste omnis blanditiis aut facilis distinctio assumenda asperiores laborum officiis quos, perferendis non pariatur sapiente minima ea deserunt repudiandae maxime consequatur.</p>
